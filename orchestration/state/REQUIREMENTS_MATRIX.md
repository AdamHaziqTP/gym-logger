...
| REQ-024 | Never claim rich Notes structure/color works without target-iPhone paste evidence. | Spec §§15.4-15.6, 32 | M03 | IN_PROGRESS (native pasteboard proof) | M03-T06 target-iPhone exact HTML replay: editable table/data/order PASS, category colours FAIL; E-004 native inspection/replay pending |
