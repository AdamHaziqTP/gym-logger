...
| REQ-024 | Never claim rich Notes structure/color works without target-iPhone paste evidence. | Spec §§15.4-15.6, 32 | M03 | PARTIALLY VERIFIED (captured native replay PASS; Phase A removal variants pending; generated Gym payload pending) | M03-T06 exact HTML replay: editable table/data/order PASS, colours FAIL; E-004 exact captured Notes replay: editable table/data/order/Unicode/colours PASS; Phase A removal variants are implemented but await the target-iPhone result; generated Gym Logger native payload remains unproven |
