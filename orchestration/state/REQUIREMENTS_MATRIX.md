...
| REQ-025 | Faithful and Compact full-session PNG export handle 40+ rows, preserve colors and notes. | Spec §14; I1-I6 | M03/M05/M06 | VERIFIED (automated; device pending) | image/export tests; M06-T05 framing review; final device gate |
...
| REQ-032 | Theme supports System/Dark/Light; export defaults dark; image style supports Compact/Faithful. | Spec §§14, 22-23 | M05-M06 | VERIFIED (automated; device pending) | M06-T02 review; 32 focused / 348 full |
...
M01 remains limited to its first-slice intent, with FIX-05 physical checks explicitly deferred rather than passed. M02-T01 through M02-T04, M03 clipboard/image work, M05 backup/export, and M06 PWA/settings/release-readiness work are accepted for automated scope where their reviews say so. The only remaining v1 gate is one consolidated human iPhone pass; no requirement may be marked physically verified by desktop evidence alone.
